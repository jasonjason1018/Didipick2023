						...
						<div class="header-row justify-content-lg-center header-border">
							...
							<nav class="primary-menu with-arrows ">
								...
								<ul class="menu-container justify-content-between">
									<li class="menu-item"><a class="menu-link" href="qa.html"><div>最新消息</div></a></li>
								...
								<div class="page-menu-row">
									...
									<nav class="page-menu-nav">
										<ul class="page-menu-container">
											<li class="page-menu-item current"><a href="qa.html"><div>常見問題</div></a></li>
											<li class="page-menu-item"><a href="shoppingprocess.html"><div>購物流程</div></a></li>
											<li class="page-menu-item"><a href="about.html"><div>關於直直買</div></a></li>
										</ul>
									</nav>
							...
							<div class="qabox">
								<div class="toggle toggle-bg">
									<div class="faq-header">
										<div class="toggle-title">如何購買直直買的商品？ 想了解更詳細的購物流程..</div>
									</div>
									
									<div class="toggle-content faq-content">
										<p>didipick是個日貨直購平台，所有的商品都是由日本直送及發貨，只要挑選您喜歡的商品加入購物車就能立即訂購囉～我們將提供買家一個信任、安全、美好的購物體驗。</p>
										<p>/ 購物流程 /</p>
										<div class="mb-5">
											<img src="images/shoppingprocess_img.png" alt="" style="width: 80%;">
										</div>
										<p>一、會員登入<br>點選【直直買】首頁的右上方圖示 >><span><img src="images/topicon_user.svg" alt="" class="shoppicon"></span>，首次購物請先完成註冊
										</p>
										<p>二、選購商品<br>可隨時pick!（挑選）您喜歡的商品來加入慾望清單，可於【直直買】首頁的右上方圖示 >><span><img src="images/topicon_heart.svg" alt="" class="shoppicon"></span>，觀看已pick!的商品</p>
										<p class="mb-0">三、加入購物車</p>
										<ol>
											<li>挑選喜歡的商品加入購物車</li>
											<li>選擇規格與數量</li>
										</ol>
										<p>四、確認購買清單<br>繼續購物或結帳</p>
										<p>五、填寫資料<br>請提供購買人資訊與收件人資訊</p>
										<p>六、付款方式<br>選擇【信用卡線上付款】或【儲值金扣款】</p>
										<p>七、確認訂單<br>若有特殊需求，請於訂單備註留言</p>
										<p>八、提交訂單，確認付款，準備期待收貨<br>我們將盡快處理您的訂單，可記下訂單編號，方便隨時查看訂單處理狀況。</p>
									</div>
									<div class="faq-else">
										<div class="faq-title">其他常見問題</div>
										<div>
											<a class="faq-item" href="">下單以後多久可以送達？</a>
											<a class="faq-item" href="">我可以選擇什麼支付方式？</a>
											<a class="faq-item" href="">結帳貨幣是用哪一種？匯率如何計算？</a>
											<a class="faq-item" href="">商品可以分開寄送嗎？</a>
											<a class="faq-item" href="">我可以選擇哪些寄送方式？</a>
										</div>
									</div>
								</div>
						...
						<div class="sidebar col-lg-3 PCOnly">
							<div class="sidebar-widgets-wrap">
								...
								<div class="widget widget_links product_lbox">
									...
									<h4>常見問題</h4>
									<ul>
										<li><a href="qa.html" title="常見問題" class="active">常見問題</a></li>
										<li><a href="shoppingprocess.html" title="購物流程">購物流程</a></li>
										<li><a href="about.html" title="關於直直買">關於直直買</a></li>
									</ul>
		...
		<footer id="footer" class="bg-transparent border-0">
			...
			<div class="container">
				<div class="footer-widgets-wrap pb-3 ">
					...
					<div class="row grid-filter-wrap">
						...
						<div class="col-lg-2 col-md-3 col-6">
							<div class="widget">
								...
								<ul class="list-unstyled iconlist ml-0">
									...
									<li><a href="forget.html">忘記密碼</a></li>
									<li><a href="order_info.html">訂單查詢</a></li>
									<li><a href="order_addvalue.html">儲值金</a></li>
						...
						<div class="col-lg-2 col-md-3 col-6">
							<div class="widget">
								...
								<ul class="list-unstyled iconlist ml-0">
									...
									<li><a href="product_top20.html">熱銷排行</a></li>
						...
						<div class="col-lg-4 col-md-8 center">
							<div class="widget footcenter">
								...
								<div class="widget subscribe-widget mt-2">
									<ul class="list-unstyled iconlist ml-0">
										<!-- <li>客服電話：<a href="#">+886 2-2577-9008</a></li> -->
										<li>客服信箱：<a href="#">info@didipick.com</a></li>
									</ul>

									<ul class="list-unstyled socialiconlist ml-0">
										<!-- <li><a href="#" target="_blank"><img src="images/socialicon_fb.png" alt=""></a></li> -->
										<!-- <li><a href="#" target="_blank"><img src="images/socialicon_ig.png" alt=""></a></li> -->
										<!-- <li><a href="#" target="_blank"><img src="images/socialicon_yt.png" alt=""></a></li> -->
										<li><a href="https://page.line.me/223vzwbz" target="_blank"><img src="images/socialicon_line.png" alt=""></a></li>
									</ul>
