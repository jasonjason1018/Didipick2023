...
<head>
	...
	<title>確認刷卡資訊｜直直買 didipick</title>
							...
							<div class="tab-content" id="tab-login">
								<div class="card mb-0">
									<div class="card-body" style="padding: 40px;">
										<form id="" name="" class="mb-0" action="" method="">
											...
											<div class="check-responsive">
												...
												<div class="check-list-item">
													<div>商品小計</div>
													<div><small>NT.</small><span id="price">505</span></div>
												</div>
												<div class="c-list-item"></div>
												<div class="check-list-item">
													<div>國際運費</div>
													<div><small>NT.</small><span id="price">348</span></div>
												</div>
												<div class="c-list-item"></div>
												<div class="check-list-item">
													<div>刷卡手續費</div>
													<div><small>NT.</small><span id="price">32</span></div>
												</div>
												<div class="c-list-item"></div>
												<div class="check-list-item t_highlight">
													<div>- 使用折價券</div>
													<div><small>NT.</small><span id="price">0</span></div>
												</div>
												<div class="c-total-item"></div>
												<div class="check-list-item lead t_didi_t">
													<div><strong>應付金額</strong></div>
													<div><small>NT.</small><strong id="price">885</strong></div>
												</div>
												<div class="check-list-item">
													<small>款項將以日幣支付</small>
													<div><small>¥ </small><strong id="price">3295</strong></div>
												</div>
										...
										<div class="check-list-btn center">
											...
											<a href="" class="button button-rounded">填寫信用卡資料</a>
										</div>
