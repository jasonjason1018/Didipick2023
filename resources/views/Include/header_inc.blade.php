				...
				<div class="header-row justify-content-lg-center header-border">
					...
					<nav class="primary-menu with-arrows ">
						...
						<ul class="menu-container justify-content-between">
												...
												<ul class="sub-menu-container">
													<li class="menu-item mega-menu-title">
													    <a class="menu-link" href="product.html">
													        <div>
													            <img src="images/product_l_icon/product_l_all.svg" alt=""> 全部商品
													        </div>
													    </a>
													</li>
													<li class="menu-item mega-menu-title">
													    <a class="menu-link" href="product.html">
													        <div>
													            <img src="images/product_l_icon/product_l_medicine.svg" alt=""> 保健品
													        </div>
													    </a>
													</li>
													<li class="menu-item mega-menu-title">
													    <a class="menu-link" href="product.html">
													        <div>
													            <img src="images/product_l_icon/product_l_makeups.svg" alt=""> 美妝
													        </div>
													    </a>
													</li>
													<li class="menu-item mega-menu-title">
													    <a class="menu-link" href="product.html">
													        <div>
													            <img src="images/product_l_icon/product_l_maintenance.svg" alt=""> 保養
													        </div>
													    </a>
													</li>
													<li class="menu-item mega-menu-title">
													    <a class="menu-link" href="product.html">
													        <div>
													            <img src="images/product_l_icon/product_l_hair.svg" alt=""> 美髮
													        </div>
													    </a>
													</li>
													<li class="menu-item mega-menu-title">
													    <a class="menu-link" href="product.html">
													        <div>
													            <img src="images/product_l_icon/product_l_life.svg" alt=""> 生活雜貨
													        </div>
													    </a>
													</li>
												</ul>
							...
							<li class="menu-item">
								<a class="menu-link" href="product_top20.html">
									<div>熱銷排行</div>
								</a>
							</li>
							<li class="menu-item">
							...
							<li class="menu-item">
								<a class="menu-link" href="qa.html">
									<div>常見問題</div>
								</a>
							</li>
						</ul>
